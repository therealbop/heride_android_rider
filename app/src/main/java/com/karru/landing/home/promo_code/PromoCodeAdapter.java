...
public class PromoCodeAdapter extends RecyclerView.Adapter<PromoCodeAdapter.ViewHolder> {
    ...
    public PromoCodeAdapter(AppTypeface appTypeface, Context mContext, ArrayList<PromoCodeDataModel> promoCodeDataModels,DateFormatter dateFormatter,PromoCodeContract.View promocodeActivityView)
    {

 ...
 * @since on 06-02-2018.
 */
public class FareBreakDownAdapter extends RecyclerView.Adapter<FareBreakDownAdapter.ReceiptDetailsHolder>
{
     ...
     */
    public FareBreakDownAdapter(Context context, AppTypeface appTypeface)
    {
    ...
    {
        Utility.printLog(TAG+ "onBindViewHolder: O"+receiptDetails.get(position).isGrandTotal());
        ...
        if(receiptDetails.get(position).isGrandTotal())
        {
        ...
        {
            holder.tv_receipt_details_devider.setVisibility(View.GONE);

...
public class SpinnerAdapter extends ArrayAdapter<com.karru.help_center.model.SpinnerRowItem>
{

    private Context mContext;
    AppTypeface appTypeface;
    private ArrayList<com.karru.help_center.model.SpinnerRowItem> spinnerRowItems;
    public SpinnerAdapter(Context mContext, int resouceId, int textviewId, ArrayList<com.karru.help_center.model.SpinnerRowItem> spinnerRowItems, AppTypeface appTypeface) {

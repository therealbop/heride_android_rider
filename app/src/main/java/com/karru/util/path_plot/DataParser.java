...
public class DataParser
{
    ...
    LatLongBounds getBounding(JSONObject jObject){
        ...
        try
        {
            ...
            JSONArray legsObject = ((JSONObject)jRoutes.get(0)).getJSONArray("legs");
            JSONObject legs = ( (JSONObject)legsObject.get(0)).getJSONObject("duration");
            String duration = legs.getString("text");
            latLngBounds = new Gson().fromJson(jBounds.toString(),LatLongBounds.class);
            latLngBounds.setDuration(duration);

...
public class AmazonUpload {
	 ...
	 */
	private static AmazonUpload instance = null;
	 ...
	 * @return
	 */
	public static AmazonUpload getInstance()
	{
		if(instance == null)
		{
			instance = new AmazonUpload();
		}
		return instance;
	}
	...
	{
		com.karru.utility.Utility.printLog("inside delete 1 "+bucketName+" "+fileName);
		...
		new Thread(new Runnable()
		{
			public void run()
			{
				try 
				{
					...
					com.karru.utility.Utility.printLog("inside delete 2");
				...
				catch(AmazonClientException e)
				{
					...
					com.karru.utility.Utility.printLog("inside delete error ");

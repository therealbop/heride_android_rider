...
public class LocationUtil implements ConnectionCallbacks, OnConnectionFailedListener, LocationListener, ResultCallback<LocationSettingsResult>, GpsStatus.Listener {
    ...
    {
        Utility.printLog("Location"+ "Connection suspended");
    ...
    {
        Utility.printLog("Location"+""+location.getLatitude()+"  "+location.getLongitude());
        /**
    ...
    public void onConnectionFailed(ConnectionResult connectionResult)
    {
        ...
        Utility.printLog("Location"+ "Connection failed: ConnectionResult.getErrorCode() = " + connectionResult.getErrorCode());
    }

...
public class Util {
    ...
    private static final int SAMSUNG_FRONT_CAM = 8;
    ...
    /**
     * Getting the image rotation degree.*/
    public static int getImage_Orientation(String photoPath)
    {
    ...
    public static int getImage_rotation_degree(int orientation)
    {
        int degrees = 0;

        switch (orientation)         //270 (3), is working for front camera picture.
        {
            case Surface.ROTATION_0:
                degrees = 0;
                break;
